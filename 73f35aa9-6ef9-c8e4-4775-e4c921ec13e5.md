# DiscordClient.developers Field
 

The developers of this bot. Used with DiscordMember.IsDeveloper.
...
**VB**<br />
``` VB
Public Shared developers As List(Of String)
```
...
**F#**<br />
``` F#
static val mutable developers: List<string>
```
