# DiscordLoginException Class
 

\[Missing <summary> documentation for "T:DSharpPlus.Objects.DiscordLoginException"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DSharpPlus.Objects.DiscordLoginException<br />
...
**VB**<br />
``` VB
Public Class DiscordLoginException
	Inherits Exception
```

**C++**<br />
``` C++
public ref class DiscordLoginException : public Exception
```

**F#**<br />
``` F#
type DiscordLoginException =  
    class
        inherit Exception
    end
```
...
<br />
The DiscordLoginException type exposes the following members.
...
Initializes a new instance of the DiscordLoginException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="608b909c-b9c2-44c3-5c77-ba4840db061c">DiscordLoginException(String)</a></td><td>
Initializes a new instance of the DiscordLoginException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="ec31f2fd-9aa6-1993-41b8-4e7e99b09277">DiscordLoginException(String, Exception)</a></td><td>
Initializes a new instance of the DiscordLoginException class</td></tr></table>&nbsp;
<a href="#discordloginexception-class">Back to Top</a>
