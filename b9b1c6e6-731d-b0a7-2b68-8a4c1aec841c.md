# Endpoints.BaseAPI Field
 

\[Missing <summary> documentation for "F:DSharpPlus.Endpoints.BaseAPI"\]
...
**VB**<br />
``` VB
Public Shared BaseAPI As String
```
...
**F#**<br />
``` F#
static val mutable BaseAPI: string
```
